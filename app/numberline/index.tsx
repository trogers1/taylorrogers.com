...
export type NumberLineLabel = {
  ...
  labelElements: ReactElement<PropsWithChildren<{ key: string }>>[];
};
...
export const NumberLine: React.FC<NumberLineProps> = ({
  ...
  return (
    <div className="relative w-full">
      ...
      {/* The NumberLine */}
      <div className="flex h-3 w-full items-center justify-items-center gap-2 text-sm text-gray-600">
        {minNumber}
        <div
          id="numberLine"
        ...
        */}
          ...
          >
            {deduplicatedPositions.map((pos, index) => {
              ...
              return (
                <React.Fragment key={`labelLine_${pos.percentage}`}>
                  {/* Space between ticks */}
                  <div
                  ...
                  >
                    ...
                    */}
                      ...
                      <div
                        ...
                        className={`z-10 h-full w-[1px] bg-gray-300 dark:bg-gray-800`}
                      />
                    </div>
                  </div>
                </React.Fragment>
            ...
            <div
              style={{
                width: `${
                  deduplicatedPositions.length
                    ? 100 -
                      deduplicatedPositions[deduplicatedPositions.length - 1]
                        .percentage
                    : 100
                }%`,
              }}
          ...
          >
            {deduplicatedPositions.map((pos, index) => {
              ...
              return (
                <React.Fragment key={`label_${pos.percentage}`}>
                  {/* Space between ticks */}
                  <div
